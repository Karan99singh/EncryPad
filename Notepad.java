...
public class Notepad extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Notepad(String filepath,String filename,String userpass) {
		setTitle("EncryPad");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 450, 300);
		path = new File(String.format("%s\\%s.txt", filepath,filename));
		checkpass = userpass;
	...
	//	}
		...
		fileExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				try {
					Encrypt.Encrun(filepath, filename, checkpass);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
